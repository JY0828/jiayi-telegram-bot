...
LIFE_DIALOGUE_CANDIDATES = (
    ...
    {
        "source": "lingoneo",
        "url": "https://www.lingoneo.org/learn-german/page/learn-essential-phrases/daily-life/at-the-supermarket/page-2394",
        "theme": "Supermarkt: nach Produkten fragen",
        "topic": "在超市询问商品位置和付款问题",
        "intro": "在德国超市、Drogerie 或药店找东西时，经常需要问 Mitarbeiter 商品在哪里、是否还有库存、能不能刷卡。这个场景练的是简短、自然、可直接开口的购物表达。",
        "verify_phrases": ("Womit kann ich Ihnen behilflich sein?", "Entschuldigung, können Sie mir helfen?", "Ich suche Kartoffelchips."),
        "dialogue": [
            ("Kundin", "Entschuldigung, können Sie mir helfen?", "不好意思，您能帮我一下吗？"),
            ("Mitarbeiter", "Natürlich. Womit kann ich Ihnen behilflich sein?", "当然。有什么可以帮您的？"),
            ("Kundin", "Können Sie mir sagen, wo ich Müsliriegel finde?", "您能告诉我燕麦棒在哪里吗？"),
            ("Mitarbeiter", "Die Müsliriegel finden Sie in Gang drei, direkt neben den Cornflakes.", "燕麦棒在第三排，Cornflakes 旁边。"),
            ("Kundin", "Danke. Und haben Sie auch glutenfreie Produkte?", "谢谢。你们也有无麸质产品吗？"),
            ("Mitarbeiter", "Ja, die stehen im Regal mit den Bio-Produkten.", "有，在有机产品的货架上。"),
            ("Kundin", "Kann ich hier mit Karte bezahlen?", "这里可以刷卡付款吗？"),
            ("Mitarbeiter", "Ja, Kartenzahlung ist möglich.", "可以，可以刷卡。"),
        ],
        "useful": [
            ("Entschuldigung, können Sie mir helfen?", "不好意思，您能帮我一下吗？", "超市、dm、Apotheke、商场"),
            ("Können Sie mir sagen, wo ich ... finde?", "您能告诉我……在哪里吗？", "找商品"),
            ("Ich suche ...", "我在找……", "超市、药店、服装店"),
            ("Haben Sie auch glutenfreie Produkte?", "你们也有无麸质产品吗？", "询问特殊商品"),
            ("Kann ich hier mit Karte bezahlen?", "这里可以刷卡吗？", "付款"),
        ],
        "substitution": [
            {"pattern": "Können Sie mir sagen, wo ich ... finde?", "items": ["Windeln", "Fiebersaft", "Müsliriegel", "Hafermilch"]},
            {"pattern": "Ich suche ...", "items": ["Kartoffelchips", "Batterien", "Kinderzahnpasta", "ein bestimmtes Medikament"]},
        ],
        "history_topics": ("Supermarkt", "Drogerie", "Einkaufen"),
    },
    {
        "source": "lingoneo",
        "url": "https://www.lingoneo.org/learn-german/page/learn-essential-phrases/leisure-time/at-the-restaurant/page-2390",
        "theme": "Restaurant: reservieren und bestellen",
        "topic": "在餐厅确认预约、点餐和提出小请求",
        "intro": "在德国餐厅常见流程是先确认有没有预订，再点饮料、询问推荐或提出儿童座椅等小请求。这个场景练的是礼貌但不绕的餐厅表达。",
        "verify_phrases": ("Haben Sie eine Reservierung?", "Haben Sie einen Tisch reserviert?", "Ja, ich habe eine Reservierung"),
        "dialogue": [
            ("Kellner", "Guten Abend. Haben Sie eine Reservierung?", "晚上好。您有预订吗？"),
            ("Gast", "Ja, ich habe eine Reservierung für drei Personen um 19 Uhr.", "有，我订了19点三个人的位置。"),
            ("Kellner", "Auf welchen Namen läuft die Reservierung?", "预订是用哪个名字？"),
            ("Gast", "Auf den Namen Wang.", "用 Wang 这个名字。"),
            ("Kellner", "Sehr gern. Folgen Sie mir bitte.", "好的。请跟我来。"),
            ("Gast", "Könnten wir bitte einen Kinderstuhl bekommen?", "可以给我们一个儿童椅吗？"),
            ("Kellner", "Natürlich. Ich bringe Ihnen gleich einen.", "当然。我马上给您拿一个。"),
            ("Gast", "Und könnten wir schon etwas Wasser bestellen?", "我们可以先点一些水吗？"),
        ],
        "useful": [
            ("Ich habe eine Reservierung für drei Personen.", "我订了三个人的位置。", "餐厅报预约"),
            ("Auf den Namen Wang.", "用 Wang 这个名字。", "餐厅、酒店、诊所前台"),
            ("Könnten wir bitte einen Kinderstuhl bekommen?", "可以给我们一个儿童椅吗？", "带孩子用餐"),
            ("Könnten wir schon etwas Wasser bestellen?", "我们可以先点水吗？", "点餐"),
            ("Folgen Sie mir bitte.", "请跟我来。", "听懂服务员引导"),
        ],
        "substitution": [
            {"pattern": "Ich habe eine Reservierung für ... Personen.", "items": ["zwei", "drei", "vier", "eine Familie mit Kind"]},
            {"pattern": "Könnten wir bitte ... bekommen?", "items": ["einen Kinderstuhl", "die Speisekarte", "etwas Wasser", "die Rechnung"]},
        ],
        "history_topics": ("Restaurant", "Reservierung", "Kinderstuhl"),
    },
    {
        "source": "lingoneo",
        "url": "https://www.lingoneo.org/learn-german/page/learn-essential-phrases/daily-life/using-public-transport/page-1764",
        "theme": "ÖPNV: Ticket und Verbindung klären",
        "topic": "乘坐公交地铁时询问车票和换乘",
        "intro": "在德国坐公交、地铁、S-Bahn 时，最常见的问题是票是否有效、在哪换乘、哪一站下车。这个场景练的是在站台或车上快速问清楚。",
        "verify_phrases": ("Using public transportation", "Practice Dialogue", "public transportation"),
        "dialogue": [
            ("Fahrgast", "Entschuldigung, ist das die richtige Bahn Richtung Hauptbahnhof?", "不好意思，这是去火车总站方向的车吗？"),
            ("Passantin", "Ja, aber Sie müssen am Marienplatz umsteigen.", "是的，但您要在 Marienplatz 换乘。"),
            ("Fahrgast", "Wissen Sie, ob mein Ticket dafür gültig ist?", "您知道我的票对这段路有效吗？"),
            ("Passantin", "Wenn es für die Zone M gilt, ja.", "如果是 M 区有效票，就可以。"),
            ("Fahrgast", "Wie viele Stationen sind es bis zum Marienplatz?", "到 Marienplatz 有几站？"),
            ("Passantin", "Drei Stationen. Danach nehmen Sie die U6.", "三站。之后您坐 U6。"),
            ("Fahrgast", "Vielen Dank, das hilft mir sehr.", "非常感谢，这很有帮助。"),
        ],
        "useful": [
            ("Ist das die richtige Bahn Richtung ...?", "这是去……方向的车吗？", "地铁、S-Bahn、公交"),
            ("Muss ich irgendwo umsteigen?", "我需要在哪里换乘吗？", "问路线"),
            ("Ist mein Ticket dafür gültig?", "我的票对这个有效吗？", "查票/买票前确认"),
            ("Wie viele Stationen sind es bis ...?", "到……还有几站？", "车上问路"),
            ("Das hilft mir sehr.", "这帮了我大忙。", "礼貌结束"),
        ],
        "substitution": [
            {"pattern": "Ist das die richtige Bahn Richtung ...?", "items": ["Hauptbahnhof", "Flughafen", "Kita", "Innenstadt"]},
            {"pattern": "Wie viele Stationen sind es bis ...?", "items": ["Marienplatz", "Hauptbahnhof", "zur Klinik", "zum Bürgerbüro"]},
        ],
        "history_topics": ("ÖPNV", "Public Transport", "U-Bahn", "S-Bahn"),
    },
    {
        "source": "lingoneo",
        "url": "https://www.lingoneo.org/learn-german/page/learn-essential-phrases/daily-life/renting-an-apartment/page-1762",
        "theme": "Wohnung: Besichtigung und Rückfragen",
        "topic": "看房时询问租金、Nebenkosten 和入住时间",
        "intro": "租房看房时，德国人会直接问 Warmmiete、Nebenkosten、Kaution、Einzugstermin 等。这个场景练的是在 Besichtigung 中自然提问。",
        "verify_phrases": ("Renting an Apartment", "A Doctor's Appointment", "Using Public Transport"),
        "dialogue": [
            ("Interessentin", "Guten Tag, ich bin wegen der Wohnungsbesichtigung hier.", "您好，我是来看房的。"),
            ("Vermieter", "Guten Tag. Kommen Sie gern herein.", "您好。请进。"),
            ("Interessentin", "Wie hoch ist die Warmmiete?", "暖租是多少？"),
            ("Vermieter", "Die Warmmiete liegt bei 1.250 Euro.", "暖租是1250欧。"),
            ("Interessentin", "Sind die Heizkosten in den Nebenkosten enthalten?", "暖气费包含在杂费里吗？"),
            ("Vermieter", "Ja, die Heizkosten sind enthalten.", "是的，暖气费包含在内。"),
            ("Interessentin", "Ab wann wäre die Wohnung frei?", "房子什么时候可以入住？"),
            ("Vermieter", "Ab dem ersten September.", "从9月1日起。"),
        ],
        "useful": [
            ("Ich bin wegen der Wohnungsbesichtigung hier.", "我是来看房的。", "看房开场"),
            ("Wie hoch ist die Warmmiete?", "暖租是多少？", "租房"),
            ("Sind die Heizkosten enthalten?", "暖气费包含在内吗？", "确认费用"),
            ("Ab wann wäre die Wohnung frei?", "房子什么时候空出来？", "入住时间"),
            ("Welche Unterlagen brauchen Sie von mir?", "您需要我提供哪些材料？", "申请房子"),
        ],
        "substitution": [
            {"pattern": "Wie hoch ist ...?", "items": ["die Warmmiete", "die Kaution", "die Nebenkosten", "die Provision"]},
            {"pattern": "Sind ... enthalten?", "items": ["die Heizkosten", "die Stromkosten", "die Betriebskosten", "die Möbel"]},
        ],
        "history_topics": ("Wohnung", "Miete", "Besichtigung"),
    },
    {
        "source": "lingoneo",
        "url": "https://www.lingoneo.org/learn-german/page/learn-essential-phrases/daily-life/at-the-train-station/page-1759",
        "theme": "Bahnhof: Zugausfall und Verspätung",
        "topic": "在火车站询问晚点、站台和换乘",
        "intro": "坐 Deutsche Bahn 时，晚点、换站台、取消班次非常常见。这个场景练的是在火车站快速问工作人员接下来怎么办。",
        "verify_phrases": ("At the Train Station", "At the Supermarket", "Driving a Car"),
        "dialogue": [
            ("Reisende", "Entschuldigung, ich habe eine Frage zu meinem Zug.", "不好意思，我想问一下我的火车。"),
            ("Mitarbeiter", "Gerne. Um welchen Zug geht es?", "好的。是哪一趟车？"),
            ("Reisende", "Um den ICE nach Berlin. Er wird als verspätet angezeigt.", "去柏林的 ICE。显示晚点了。"),
            ("Mitarbeiter", "Der Zug hat voraussichtlich 25 Minuten Verspätung.", "这趟车预计晚点25分钟。"),
            ("Reisende", "Verpasse ich dadurch meinen Anschluss?", "这样我会错过换乘吗？"),
            ("Mitarbeiter", "Das könnte knapp werden. Ich suche Ihnen eine Alternative heraus.", "可能会有点赶。我帮您查一个替代方案。"),
            ("Reisende", "Fährt der Zug weiterhin von Gleis 6?", "这趟车还是从6站台发车吗？"),
            ("Mitarbeiter", "Nein, heute von Gleis 8.", "不是，今天从8站台。"),
        ],
        "useful": [
            ("Ich habe eine Frage zu meinem Zug.", "我想问一下我的火车。", "火车站问询"),
            ("Er wird als verspätet angezeigt.", "显示晚点了。", "DB App/车站屏幕"),
            ("Verpasse ich dadurch meinen Anschluss?", "这样我会错过换乘吗？", "换乘风险"),
            ("Ich suche Ihnen eine Alternative heraus.", "我帮您查一个替代方案。", "听懂工作人员说明"),
            ("Fährt der Zug weiterhin von Gleis 6?", "这趟车还是从6站台发车吗？", "确认站台"),
        ],
        "substitution": [
            {"pattern": "Ich habe eine Frage zu ...", "items": ["meinem Zug", "meinem Ticket", "meinem Anschluss", "meiner Reservierung"]},
            {"pattern": "Fährt der Zug von Gleis ...?", "items": ["Gleis 3", "Gleis 6", "Gleis 8", "dem gleichen Gleis"]},
        ],
        "history_topics": ("Deutsche Bahn", "Bahnhof", "Verspätung"),
    },
    {
        "source": "lingoneo",
        "url": "https://www.lingoneo.org/learn-german/page/learn-essential-phrases/daily-life/taking-a-taxi/page-1763",
        "theme": "Taxi: Ziel und Preis klären",
        "topic": "坐出租车时说明目的地和询问费用",
        "intro": "在德国坐 Taxi 或叫车时，需要清楚说目的地、问大概价格、确认能否刷卡。这个场景也适合机场、医院回家等情况。",
        "verify_phrases": ("Wohin wollen Sie?", "Wohin soll es gehen?", "Von hier zum Flughafen kostet es ungefähr 50"),
        "dialogue": [
            ("Fahrer", "Guten Tag. Wohin soll es gehen?", "您好。去哪里？"),
            ("Fahrgast", "Zum Kinderkrankenhaus, bitte.", "去儿童医院，谢谢。"),
            ("Fahrer", "Alles klar. Soll ich die schnellste Route nehmen?", "好的。要走最快路线吗？"),
            ("Fahrgast", "Ja, bitte. Wir haben dort einen Termin.", "是的，谢谢。我们在那里有预约。"),
            ("Fahrer", "Von hier dauert es ungefähr 20 Minuten.", "从这里过去大约20分钟。"),
            ("Fahrgast", "Können Sie ungefähr sagen, was es kostet?", "您能大概说一下费用吗？"),
            ("Fahrer", "Ungefähr 30 Euro, je nach Verkehr.", "大约30欧，取决于交通情况。"),
            ("Fahrgast", "Kann ich mit Karte bezahlen?", "我可以刷卡吗？"),
        ],
        "useful": [
            ("Zum Kinderkrankenhaus, bitte.", "去儿童医院，谢谢。", "出租车说明目的地"),
            ("Wir haben dort einen Termin.", "我们在那里有预约。", "说明赶时间原因"),
            ("Wie lange dauert es ungefähr?", "大概要多久？", "问路程时间"),
            ("Was kostet es ungefähr?", "大概要多少钱？", "问费用"),
            ("Kann ich mit Karte bezahlen?", "我可以刷卡吗？", "付款"),
        ],
        "substitution": [
            {"pattern": "Zum ..., bitte.", "items": ["Kinderkrankenhaus", "Bahnhof", "Flughafen", "Bürgerbüro"]},
            {"pattern": "Wir haben dort ...", "items": ["einen Termin", "eine Untersuchung", "einen Anschlusszug", "einen Flug"]},
        ],
        "history_topics": ("Taxi", "Krankenhaus", "Flughafen"),
    },
    {
        "source": "lingoneo",
        "url": "https://www.lingoneo.org/learn-german/page/learn-essential-phrases/daily-life/at-the-hairdressers/page-1757",
        "theme": "Friseur: Termin und Wunsch erklären",
        "topic": "理发时说明想怎么剪、是否预约",
        "intro": "虽然不是高压场景，但 Friseur 对话很适合练“我想要……”“只稍微……”“不要太短”这类德国生活高频表达。",
        "verify_phrases": ("Ich hätte meine Haare gerne gewaschen und geschnitten.", "Könnte ich meine Haare einfach ein wenig kürzer haben?", "Ich möchte meine Haare so lange wie möglich lassen."),
        "dialogue": [
            ("Friseurin", "Hallo, haben Sie einen Termin?", "您好，您有预约吗？"),
            ("Kundin", "Ja, ich habe um 15 Uhr einen Termin.", "有，我预约的是15点。"),
            ("Friseurin", "Was möchten Sie heute machen lassen?", "您今天想做什么？"),
            ("Kundin", "Ich hätte meine Haare gerne gewaschen und geschnitten.", "我想洗剪。"),
            ("Friseurin", "Wie viel darf ab?", "可以剪掉多少？"),
            ("Kundin", "Nur ein wenig, bitte. Ich möchte sie nicht zu kurz haben.", "只剪一点点，谢谢。我不想太短。"),
            ("Friseurin", "Soll ich die Spitzen schneiden?", "我剪一下发尾可以吗？"),
            ("Kundin", "Ja, genau. Nur die Spitzen.", "对，没错。只剪发尾。"),
        ],
        "useful": [
            ("Ich habe um 15 Uhr einen Termin.", "我预约的是15点。", "理发/医生/行政预约"),
            ("Ich hätte meine Haare gerne gewaschen und geschnitten.", "我想洗剪。", "理发"),
            ("Nur ein wenig, bitte.", "只要一点点，谢谢。", "说明程度"),
            ("Ich möchte sie nicht zu kurz haben.", "我不想剪太短。", "理发"),
            ("Nur die Spitzen.", "只剪发尾。", "理发"),
        ],
        "substitution": [
            {"pattern": "Ich hätte ... gerne ...", "items": ["meine Haare gewaschen", "einen Termin", "eine Beratung", "die Spitzen geschnitten"]},
            {"pattern": "Nur ..., bitte.", "items": ["ein wenig", "die Spitzen", "kurz prüfen", "waschen und schneiden"]},
        ],
        "history_topics": ("Friseur", "Termin", "Haare schneiden"),
    },
)
